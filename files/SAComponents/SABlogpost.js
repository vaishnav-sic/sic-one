        ...
        <div className="blogpost1-in">
          ...
          <div className="blogpost-in-right">
            <div className="blogpostin-right-text">
              ...
              <div className="animation">
                <br />
                श्री.विजय पवार, श्री.वीरेंद्र पवार
                <br />
                श्री.अजय पवार, श्री.गोरख पवार
                <br />
                श्री.देवदास पवार, श्री.सागर पवार
                <br />
                श्री.रुपेश पवार, श्री.विवेक पवार
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="blogpost1-in">
          ...
          <div className="blogpost-in-right">
            <div className="blogpostin-right-text">
              ...
              <div className="animation">
                <br />
                श्री. एकनाथ मानसिंग पवार
                <br />
                श्री. जयकुमार जयसिंग पवार
                <br />
                श्री. संदीप तानाजी पवार
                <br /> मो. 9579144667
                <br /> 7889361902
              </div>
            </div>
